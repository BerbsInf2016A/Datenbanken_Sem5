...
tempData <- read.csv('pickup.csv', stringsAsFactors = FALSE)
...
png(filename = "Chicagomap_pickup_tile.png", width = 800, height = 600, units = "px")
...
png(filename = "Chicagomap_pickup_point.png", width = 800, height = 600, units = "px")
